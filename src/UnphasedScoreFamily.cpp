        ...
        if (!sumZero) {
            ...
            for (int sib = 0; sib < nsib; sib++) {
                ...
                if (!options.genotype) {
                    ...
                    if (!options.chrX) {
                        if (!family.sibship) {
                        	if(typeOfPhenotype=="polytomous") familyCount[(int) sibTrait[sib] + 3][whichHaps[0][1][1]] += sumX;
                ...
                if (!family.sibship) {
                    if(typeOfPhenotype=="polytomous") familyCount[(int) sibTrait[sib] + 3][whichHaps[1][1][1]] += sumX;
