                        ...
                        for (int mphase = 0; mphase < nphase; mphase++) {
                            ...
                            for (int sib = 0; sib < nsib; sib++) {
                                ...
                                if (!MchrX) {
                                    ...
                                    if (typeOfPhenotype == "polytomous") {
                                    	if (sibTrait[sib] < K) betaparent0Gradient[sibTrait[sib]] -= betaparent[i + (sibTrait[sib]-1)*nhap] * derivTermft;
                                    	}
                                ...
                                if (typeOfPhenotype == "polytomous") {
                                    if (sibTrait[sib] < K) betaparent0Gradient[sibTrait[sib]] -= betaparent[i + (sibTrait[sib]-1)*nhap] * derivTermmt;
                                    }
